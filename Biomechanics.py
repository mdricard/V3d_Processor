...
class Biomechanics:
    ...
    def __init__(self, filename):
        ...
        self.FP2_Y = data[:, 11]
        self.FP2_Z = data[:, 12]
        self.R_HIP_Jt_Angle_X = data[:, 13]
        self.R_HIP_Jt_Angle_Y = data[:, 14]
        self.R_HIP_Jt_Angle_Z = data[:, 15]
        self.R_Shank_Vel_X = data[:, 16]
        self.R_Shank_Vel_Y = data[:, 17]
        self.R_Shank_Vel_Z = data[:, 18]
        self.Rt_Knee_Jt_Angle_X = data[:, 19]
        self.Rt_Knee_Jt_Angle_Y = data[:, 20]
        self.Rt_Knee_Jt_Angle_Z = data[:, 21]
        self.Rt_Knee_Jt_Force_X = data[:, 22]
        self.Rt_Knee_Jt_Force_Y = data[:, 23]
        self.Rt_Knee_Jt_Force_Z = data[:, 24]
        self.Rt_Knee_Jt_Moment_X = data[:, 25]
        self.Rt_Knee_Jt_Moment_Y = data[:, 26]
        self.Rt_Knee_Jt_Moment_Z = data[:, 27]
